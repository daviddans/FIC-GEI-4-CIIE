...
class TestScene(abstract.Scene):
    ...
    def update(self, dt):
        ...
        self.switch1.update(dt, self.player.pos)
        self.switch2.update(dt, self.player.pos)
        self.door1.update(dt, self.player.pos)
        self.door2.update(dt, self.player.pos)
        self.door3.update(dt, self.player.pos)
